<?php
/**
 * Template Name: Vip Dashboard Greek Aesthetic
 * Template generated from `vip_dashboard_greek_aesthetic/code.html`
 *
 * @package ViaR_Luxury
 */
...
<button class="w-full py-4 bg-[#C5A059] text-[#00234B] font-cta text-sm uppercase tracking-widest transition-all hover:opacity-90">
...
<!-- TopAppBar -->
<!-- Page Content -->
<div class="pt-32 px-12 pb-24 max-w-[1440px] mx-auto">
<header class="mb-16">
...
<img alt="Luxury Transfer Vehicle" class="w-full h-full object-cover" data-alt="A pristine silver luxury sedan parked on a cobblestone path in front of a white-washed Cycladic villa in Santorini. The warm golden hour sun of a Greek sunset casts long, elegant shadows and reflects off the deep blue Aegean Sea in the background. The scene is quiet, exclusive, and breathtakingly beautiful, epitomizing premium Mediterranean travel." src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/remote-8948fd4efa68.jpg"/>
</div>
