    ...
    if ($post_type === 'page') {
        ...
        if ($post_id > 0) {
            ...
            if ($template === 'templates/page-vip-transfers-services.php') {
                return 'ViaR Editor Guide: Use ViaR VIP Transfers Page Content for every section on this page (hero, services, fleet header, form intro, stats, and CTA). Fleet vehicles are managed separately under Fleets. Keep the page editor empty to use the designed layout.';
            }
        }
