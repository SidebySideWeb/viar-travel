...
$viar_hero_eyebrow = viar_field_value('viar_hero_eyebrow', 'OUR PHILOSOPHY');
$viar_hero_title = viar_field_value('viar_hero_title', 'Crafting the Unattainable');
$viar_hero_description = viar_field_value('viar_hero_description', 'ViaR Travel is not a booking platform. We are architects of time and curators of experience, dedicated to uncovering the soul of Greece for those who demand the extraordinary.');
$viar_hero_cta_label = viar_field_value('viar_hero_cta_label', 'Book a Private Call');
$viar_hero_cta_url = viar_field_value('viar_hero_cta_url', home_url('/contact'));
