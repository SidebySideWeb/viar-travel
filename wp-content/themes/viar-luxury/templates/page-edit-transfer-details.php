<?php
/**
 * Template Name: Edit Transfer Details
 * Template generated from `edit_transfer_details/code.html`
 *
 * @package ViaR_Luxury
 */
...
<img alt="Luxury Sedan" class="w-full h-48 object-cover mb-6" data-alt="A sleek, black high-end luxury sedan parked in front of a modern glass skyscraper during the blue hour. The car's polished surface reflects the soft architectural lights of the city. The composition is clean and minimalist, emphasizing professional travel, quiet power, and executive exclusivity in a sophisticated urban setting." src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/remote-04b7a795023b.jpg"/>
<div class="space-y-4">
